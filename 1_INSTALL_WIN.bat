...
echo ==========================================================
echo 💻 Theology AI Lab - Local Edition Installer (Windows)
echo ==========================================================
echo.

cd /d "%~dp0"

:: 1. Check Python 3.11/3.12
python --version 2>NUL
if errorlevel 1 goto :NoPython
python -c "import sys; exit(0 if (3, 11) <= sys.version_info < (3, 13) else 1)" 2>NUL
if errorlevel 1 goto :OldPython

echo ✅ Python 3.11/3.12 감지됨.
goto :CreateVenv
...
:OldPython
echo ❌ Python 버전이 맞지 않습니다. (3.11 또는 3.12 필요)
echo 👉 https://www.python.org/downloads/ 에서 Python 3.11 또는 3.12를 설치해주세요.
pause
exit /b
...
if not exist ".env" (
    ...
    (
        ...
        echo.
        echo # [Settings]
        echo APP_TITLE=Theology AI Lab ^(Local^)
    ) > .env
